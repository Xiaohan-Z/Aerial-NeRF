...
if __name__ == '__main__':
    ...
    parser.add_argument('--folder', type=str,default='/home/hanxiao/xiaohan/data/AN_data_own/own_data', help='Project dir.')
    ...
    image_dir = '/home/hanxiao/xiaohan/data/AN_data_own/images'
    model_dir = '/home/hanxiao/xiaohan/data/AN_data_own/own_data/bin'
    # model_dir = os.path.join(args.folder, 'dslr_calibration_undistorted')
    cam_dir = '/home/hanxiao/xiaohan/data/AN_data_own/own_data/cams_1'
    renamed_dir = '/home/hanxiao/xiaohan/data/AN_data_own/images_1'
